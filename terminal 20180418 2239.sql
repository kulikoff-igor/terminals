...
-- Дата скрипта: 18.04.2018 22:39:25
...
CREATE TABLE trans_pid_group (
  ...
  CONSTRAINT FK1shfq4venmaard3i1d3l3a4ms FOREIGN KEY (id_trans_scheme)
    REFERENCES trans_scheme(id_trans_scheme) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT FKjgbjhr5e3tncylrv7c4bofh5s FOREIGN KEY (id_pid_group)
