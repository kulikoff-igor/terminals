...
-- Дата скрипта: 14.05.2018 10:00:45
...
(2, 'ПР-Т ЖЕЛЕЗНОДОРОЖНЫЙ, 45-2', 'МИНСК', 'finco@mail.ru', 'ОАО РАДУГА', '+375443838921', 201111),
(3, 'УЛ.КИРОВА, 4', 'МИНСК', 'balfol@mail.ru', 'ИП РУДЬКО П.Н.', '+375258765941', 232001),
(4, 'cxvb', 'cvb', 'sdf', 'sdf', 'sdf', 4353),
(5, 'asd', 'asd', 'asd', 'asd', 'asd', 345),
(6, 'Солигорск', 'Заслонова 67', 'i.kulikov@gmail.com', 'НПО', '+375445566340', 223710),
(7, 'sdfdf', 'vcbnhgn', 'fsdgsr@dsgds.com', '234214', 'впраропро', 225415);
...
--
INSERT INTO trans_pid_group VALUES
(5, 1, 1),
(6, 1, 2),
(7, 1, 3),
(8, 1, 4),
...
(6, 'УЛ.МАРШАЛЛА ЛОСИКА', 'ПАВИЛЬОН 10', 'Минск', 200310, 8, 4, 4),
(7, 'УЛ.ОКТЯБРЬСКАЯ, 13', 'Минск', 'GREEN', 256301, 6, 3, 3),
(8, 'укцецук', 'уцкеуцке', 'цкуеку', 2342323, 3, 3, 4),
(9, 'пьроь', 'прьапе', 'пкарт', 3456567, 4, 6, 3),
(10, 'вапв', 'ывпвап', 'вапва', 23141234, 3, 7, 2);
...
(5, 'тестовые опреации', 2, 2),
(6, 'тестовые операции', 2, 12);
